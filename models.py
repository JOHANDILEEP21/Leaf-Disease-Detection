...
class leaf_disease_detection:
    ...
    def testing(path):
        ...
        ldd_model = pickle.load(open('https://github.com/JOHANDILEEP21/Leaf-Disease-Detection/blob/1f6c080d0374784f4e33540a3c27aed0836028fa/Leaf_disease_detection.pkl', 'rb'))
